...
void OpenADC10(unsigned int, unsigned int, unsigned int,
     unsigned int, unsigned int);              /* config ADC */

void ConvertADC10(void);                       /* Start an A/D conversion */

void SetChanADC10(unsigned int);  			   /* Set A/D to specified channel */

unsigned int ReadADC10(unsigned char);         /*Read A/D result */

void CloseADC10(void);                         /* Turn off A/D */

char BusyADC10();                              /* Check status of A/D conversion */

void ConfigIntADC10(unsigned int); 
